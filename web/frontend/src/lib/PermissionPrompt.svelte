...
<div class="my-2 rounded-lg border border-amber-400/60 dark:border-amber-500/40 bg-amber-50/50 dark:bg-amber-950/20 text-sm overflow-hidden">
    ...
    {#if Object.keys(args).length > 0}
        <div class="border-t border-amber-300/30 dark:border-amber-700/30 px-3 py-2">
            <pre class="text-xs text-zinc-500 dark:text-zinc-400 whitespace-pre-wrap break-all font-mono leading-relaxed">{formatArgs(args)}</pre>
        </div>
    {/if}
    <div class="border-t border-amber-300/30 dark:border-amber-700/30 px-3 py-2 flex gap-2 justify-end">
        <button
